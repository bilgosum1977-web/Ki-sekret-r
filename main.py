...
def duckduckgo_fallback(keyword: str):
    url = f"https://duckduckgo.com/html/?q={keyword}+kaufen+preis+produkt"
...
# --- HAUPT-MESSAGE-VERARBEITUNG (ASYNC ROUTER) ---
def process_message_async(chat_id, user_text, loading_msg_id):
    try:
        ...
        # 1. GitHub Code Update Freigabe Logik abfangen
        ...
        # 3. Intent-Erkennung & Produktmuster
        ...
        if intent is None:
            # Fallback für normale Konversation über Standard-Groq Textmodell
        ...
        # 4. Keyword bereinigen für Produktsuche
        ...
        # Fortschritt melden / Shopping-Seite anzeigen
